 ...
 *
 * Copyright 2018-2019 David Luna.
 *
 */
 ...
 */
public class ProfileAttributeToStateNodePlugin extends AbstractNodeAmPlugin {
    ...
    protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
        return Collections.singletonMap(ProfileAttributeToStateNodePlugin.currentVersion,
                Collections.singletonList(ProfileAttributeToStateNode.class));
    }
    ...
    public String getPluginVersion() {
        return ProfileAttributeToStateNodePlugin.currentVersion;
    }
}
